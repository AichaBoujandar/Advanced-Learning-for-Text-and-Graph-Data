...
G = nx.read_weighted_edgelist('C:/Users/Aicha BOUJANDAR/Desktop/3A/ALTEGRAD/TP6/code/data/karate.edgelist', delimiter=' ', nodetype=int, create_using=nx.Graph())
...
class_labels = np.loadtxt('C:/Users/Aicha BOUJANDAR/Desktop/3A/ALTEGRAD/TP6/code/data/karate_labels.txt', delimiter=',', dtype=np.int32)
